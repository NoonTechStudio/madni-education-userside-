...
const schoolLinks = [
  { label: "Sabri High School, Vadodara",    href: "#" },
  { label: "Noor Academy, Surat",            href: "#" },
  { label: "Al-Huda Primary School, Bharuch",href: "#" },
  { label: "Madni Girls' School, Ankleshwar",href: "#" },
];

const trustInfo = [
  { label: "Registration No.",  value: "GUJ/2012/0043721"  },
  { label: "Zakat Eligibility", value: "Verified — Asnaf Category" },
  { label: "80G Certificate No.", value: "AADTM4782QE2023" },
];
        ...
        >
          ...
          <div>
            ...
            >
              ...
              sadaqah, and community generosity since 2012.
            </p>
            ...
            >
              {["✅ Zakat Eligible", "✅ 80G Certified", "✅ Audited"].map((badge) => (
                <span
                  key={badge}
                  style={{
      ...
      >
        ...
        >
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.40)" }}>
            © 2025 Madni Education Trust · All rights reserved.
          </p>
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.40)" }}>
